...
# DataSet Information
parser.add_argument('--main_path', default='/your path to main directory/', type=str)

parser.add_argument('--root', default='/your path to the data folder(i.e. containing BraTS2021_TrainingData)/', type=str)
...
parser.add_argument('--train_file', default='/your path to the generated train.txt/', type=str)

parser.add_argument('--valid_file', default='/your path to the generated valid.txt/', type=str)

parser.add_argument('--dataset', default='brats', type=str)

parser.add_argument('--model_name', default='BiTrUnet', type=str)
...
def main_worker():
    if args.local_rank == 0:
        log_dir = os.path.join(arg.main_path, 'log', args.experiment+args.date)
    ...
    train_root = os.path.join(arg.root, args.train_dir)
